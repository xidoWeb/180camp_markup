...
const naviChild2 = navi2.children;

const linkData = naviChild2[0].querySelector('a').getAttribute('href');
// console.log( linkData );

naviChild2[2].querySelector('a').setAttribute('href','http://kakao.com');

// naviChild2[4].setAttribute('class','on');
const na4 = naviChild2[4].classList;
na4.add('on');
...
// 배열, 유사배열
const navLi = Array.from(naviChild2);
navLi.forEach(function(element, index){
  element.addEventListener('click', function(e){
    e.preventDefault();

    console.log(element, index);
    // element.style = 'border:1px solid #f00; border-radius:3px';
